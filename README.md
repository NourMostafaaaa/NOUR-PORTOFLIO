...
<head>
  ...
  <title>Nour Moustafa — Tech Portfolio</title>
  <meta name="description" content="Portfolio of Nour Moustafa — Computer Engineering & IT student. Data analysis, ML, web, and software projects." />
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    header{position:sticky;top:0; z-index:50; backdrop-filter:saturate(180%) blur(8px); background:rgba(5,7,13,.7); border-bottom:1px solid rgba(255,255,255,.06)}
    nav{display:flex;align-items:center;justify-content:space-between;gap:16px}
    .brand{display:flex;align-items:center;gap:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase}
    .brand .dot{width:12px;height:12px;border-radius:50%;background:linear-gradient(135deg, var(--neon), var(--neon2)); box-shadow:0 0 16px var(--neon)}
    .navlinks a{margin:0 10px; font-weight:600; opacity:.9}
    .cta{display:inline-flex;align-items:center;gap:10px;background:linear-gradient(135deg, var(--neon), var(--neon2));
         color:#001018;border:none;padding:10px 14px;border-radius:12px;font-weight:800; box-shadow:0 10px 30px rgba(51,209,255,.25);}
    .cta:hover{filter:brightness(1.05)}

    .hero{display:grid;grid-template-columns:1fr 1fr;gap:28px;align-items:center;padding:60px 0}
    .hero h1{font-size:46px;line-height:1.1;margin:0 0 12px;text-shadow:0 0 10px rgba(0,234,255,.4)}
    .hero p.lead{color:var(--muted);font-size:18px;margin:8px 0 18px}
    .badges{display:flex;flex-wrap:wrap;gap:10px;margin:16px 0}
    .badge{border:1px solid rgba(255,255,255,.12); padding:8px 10px; border-radius:999px; color:#cfe4ff; background:rgba(255,255,255,.05); box-shadow:0 0 8px rgba(0,234,255,.15)}
    .card{background:linear-gradient(180deg, rgba(255,255,255,.04), rgba(255,255,255,.02)); border:1px solid rgba(255,255,255,.08); border-radius:16px; padding:18px; box-shadow:0 0 20px rgba(124,92,255,.08)}
...
<body>
  ...
  <!-- ===== Animated Network Background Script ===== -->
  <script>
